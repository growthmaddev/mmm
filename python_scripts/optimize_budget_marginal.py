...
def optimize_budget(
    ...
    if abs(budget_diff) > 5000:  # Only adjust if budgets differ significantly
        ...
        if budget_diff > 0:
            ...
            if expected_outcome > projected_outcome:
                ...
                expected_lift = max(0.5, percent_vs_projected)  # Minimum 0.5% improvement
                ...
                expected_lift = max(0.05, standard_lift / 10)  # Very modest but positive lift
            ...
            if roi_pct_change > 0:
                ...
                expected_lift = max(0.01, standard_lift)  # At least minimal improvement
        ...
        expected_lift = max(0.05, standard_lift)  # At least 0.05% improvement
    ...
    expected_lift = max(0.01, min(50, expected_lift))  # Between 0.01% and 50%
